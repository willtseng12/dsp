...
>> I prefer using emacs, there seems to be more customization. Also it explicitly provides help and shows you how to get it.
...
>> I prefer using Spyder. I have been using it when I took other coding classes online. It lets me debug my code. It has three major windows and I can customize what I want to see in each window (editor, variables, console). I can script my code and run it all together at once when I am ready.
